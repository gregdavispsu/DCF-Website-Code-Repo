...
class IT_Exchange_Abandoned_Cart {
	...
	*/
	function IT_Exchange_Abandoned_Cart( $post=false ) {
		...
		if ( ! $post )
			return new WP_Error( 'it-exchange-product-not-a-wp-post', __( 'The IT_Exchange_Abandoned_Cart class must have a WP post object or ID passed to its constructor', 'it-l10n-exchange-addon-abandoned-carts' ) );
