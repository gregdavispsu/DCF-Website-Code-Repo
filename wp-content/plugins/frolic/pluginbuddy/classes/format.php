...
class pb_frolic_format {
	...
	// ********** PRIVATE PROPERTIES **********
	private $_timestamp = 'M j, Y H:i:s';
	...
	function time_duration( $seconds ) {
		...
		$periods = array(__('second', 'it-l10n-frolic'),
						 __('minute', 'it-l10n-frolic'),
						 __('hour',   'it-l10n-frolic'),
						 __('day', 	  'it-l10n-frolic'),
						 __('week',   'it-l10n-frolic'),
						 __('month',  'it-l10n-frolic'),
						 __('year',   'it-l10n-frolic'),
						 __('decade'. 'LION')
						 );
