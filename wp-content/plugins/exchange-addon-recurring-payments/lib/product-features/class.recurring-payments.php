...
class IT_Exchange_Recurring_Payments {
	...
	*/
	function register_metabox() {
		add_meta_box( 'it-exchange-recurring-payments', __( 'Recurring Options', 'it-l10n-exchange-addon-recurring-payments' ), array( $this, 'print_metabox' ), 'it_exchange_prod', 'it_exchange_advanced', 'high' );
	}
	...
	*/
	function print_metabox( $post ) {
	    ...
	    $interval_types = array(
		    'day'   => __( 'Day(s)', 'it-l10n-exchange-addon-recurring-payments' ),
		    'week'  => __( 'Week(s)', 'it-l10n-exchange-addon-recurring-payments' ),
		    'month' => __( 'Month(s)', 'it-l10n-exchange-addon-recurring-payments' ),
		    'year'  => __( 'Year(s)', 'it-l10n-exchange-addon-recurring-payments' ),
		);
        ...
        <div id="it-exchange-recurring-payment-settings">
	        <label for="it-exchange-recurring-payments-enabled"><?php _e( "Enable Recurring Payments?", 'it-l10n-exchange-addon-recurring-payments' ); ?>
	        ...
	        <div id="recurring-payment-options" class="<?php echo $hidden; ?>">
		        <p>
			        <label for="it-exchange-recurring-payments-interval">
				        <?php _e( 'Recurs every...', 'it-l10n-exchange-addon-recurring-payments' ); ?>
			        </label>
			        &nbsp;
		        ...
		        <label for="it-exchange-recurring-payments-auto-renew"><?php _e( "Enable Auto-Renewing?", 'it-l10n-exchange-addon-recurring-payments' ); ?>
		        ...
		        <div id="trial-period-settings" class="<?php echo $trial_hidden; ?>">
			        ...
			        <label for="it-exchange-recurring-payments-trial-enabled"><?php _e( "Enable a Trial Period?", 'it-l10n-exchange-addon-recurring-payments' ); ?>
			        ...
			        <p id="trial-period-options" class="<?php echo $trail_options_hidden; ?>">
				        <label for="it-exchange-recurring-payments-trial-interval-count">
					        <?php _e( 'Free trial for...', 'it-l10n-exchange-addon-recurring-payments' ); ?>
				        </label>
				        &nbsp;
