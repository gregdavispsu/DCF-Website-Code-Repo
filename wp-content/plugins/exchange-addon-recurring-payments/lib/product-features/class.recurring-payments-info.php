...
class IT_Exchange_Recurring_Payments_Info {
	...
	*/
	function register_metabox() {
		add_meta_box( 'it-exchange-recurring-payments-info', __( 'Recurring Payments Info', 'it-l10n-exchange-addon-recurring-payments' ), array( $this, 'print_metabox' ), 'it_exchange_prod', 'it_exchange_normal', 'high' );
	}
	...
	*/
	function print_metabox( $post ) {
		...
		<div id="it-exchange-recurring-payment-info-icon">
			<span class="tip" title="<?php _e( 'Recurring Payment options have moved to the Advanced section.', 'it-l10n-exchange-addon-recurring-payments' ); ?>">i</span>
		</div>
		<?php
	}
}
