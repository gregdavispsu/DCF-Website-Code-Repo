...
function it_exchange_register_recurring_payments_addon() {
	$options = array(
		'name'              => __( 'Recurring Payments', 'it-l10n-exchange-addon-recurring-payments' ),
		'description'       => __( 'This add-on turns on recurring payments for supporting payment gateways.', 'it-l10n-exchange-addon-recurring-payments' ),
		'author'            => 'iThemes',
...
function it_exchange_recurring_payments_set_textdomain() {
	load_plugin_textdomain( 'it-l10n-exchange-addon-recurring-payments', false, dirname( plugin_basename( __FILE__  ) ) . '/lang/' );
}
