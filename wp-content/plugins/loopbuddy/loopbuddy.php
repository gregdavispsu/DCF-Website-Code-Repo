	...
	************************************************************************************/
	...
	function render_loop( $query_id, $layout_id, $widget = false ) {
		...
		if ( isset( $enable_paging ) && $enable_paging == 'on' ) {
			...
			?>	
				<div id="nav-below" class="navigation loop-utility loop-utility-below">
					<div class="nav-previous"><?php previous_posts_link( __( '<span class="meta-nav">&larr;</span> Previous', 'it-l10n-loopbuddy' ) ); ?></div> <!-- 38solutions -->
					<div class="nav-next"><?php next_posts_link( __( 'Next <span class="meta-nav">&rarr;</span>', 'it-l10n-loopbuddy' ) ); ?></div>				<!-- 38solutions -->
<!--
					<div class="nav-previous"><?php next_posts_link( __( '<span class="meta-nav">&larr;</span> Older', 'it-l10n-loopbuddy' ) ); ?></div>
...
-->				
			...
			?>
					<div id="nav-below" class="navigation loop-utility loop-utility-below">
						<div class="nav-previous"><?php echo $this->pb_lb_widget_link( __( '<span class="meta-nav">&larr;</span> Previous', 'it-l10n-loopbuddy' ), 'next' ); ?></div> <!-- 38solutions -->
						<div class="nav-next"><?php echo $this->pb_lb_widget_link( __( 'Next <span class="meta-nav">&rarr;</span>', 'it-l10n-loopbuddy' ), 'previous'  ); ?></div>    <!-- 38solutions -->
<!--
