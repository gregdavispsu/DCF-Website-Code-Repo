...
function it_exchange_register_custom_url_tracking_addon() {
	$options = array(
		'name'              => __( 'Custom URL Tracking', 'it-l10n-exchange-addon-custom-url-tracking' ),
...
function it_exchange_custom_url_tracking_set_textdomain() {
	load_plugin_textdomain( 'it-l10n-exchange-addon-custom-url-tracking', false, dirname( plugin_basename( __FILE__  ) ) . '/lang/' );
}
