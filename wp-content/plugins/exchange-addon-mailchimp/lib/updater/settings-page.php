		...
		<div id="ithemes-updater-settings">
			...
			<table class="form-table">
				<tbody>
					<tr valign="top">
						<th scope="row">
							<label for="quick_releases"><?php _e( 'Quick Release Updates', 'it-l10n-exchange-addon-mailchimp' ); ?></label>
						</th>
						<td>
