<?php
/**
 * This is the MailChimp signup template part for the save field in the content-registration template part
 * @since 1.0.0
 * @version 1.0.0
 * @package IT_Exchange_Addon_MailChimp
*/
?>
<?php do_action( 'it_exchange_content_registration_fields_before_mailchimp_signup' );
...
do_action( 'it_exchange_content_registration_fields_after_mailchimp_signup' ); ?>