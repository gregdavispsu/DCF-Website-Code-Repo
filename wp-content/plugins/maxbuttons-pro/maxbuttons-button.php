...
if (isset($_GET['id']) && $_GET['id'] != '' && intval($_GET['id']) != 0) {
	$button = mbpro_get_button(intval($_GET['id']) );
...
$maxbutton_use_font_awesome_icon_value = isset($button) ? $button->use_font_awesome_icon : '';
$maxbutton_font_awesome_icon_value = isset($button) ? $button->font_awesome_icon : $maxbutton_font_awesome_icon_default;
$maxbutton_font_awesome_icon_size_value = isset($button) ? $button->font_awesome_icon_size : $maxbutton_font_awesome_icon_size_default;
...
$maxbutton_icon_color_value = isset($button) ? $button->icon_color : '';
$maxbutton_icon_color_display = ($maxbutton_icon_color_value != '') ? $maxbutton_icon_color_value : $maxbutton_icon_color_default;
...
$maxbutton_icon_color_hover_value = isset($button) ? $button->icon_color_hover : '';
$maxbutton_icon_color_hover_display = ($maxbutton_icon_color_hover_value != '') ? $maxbutton_icon_color_hover_value : $maxbutton_icon_color_hover_default;
...
if ($_POST) {
	...
	$data = array(
        ...
        'use_font_awesome_icon' => isset($_POST[$maxbutton_use_font_awesome_icon_key]) ? $wpdb->escape($_POST[$maxbutton_use_font_awesome_icon_key]) : '',
		'font_awesome_icon' => stripslashes($_POST[$maxbutton_font_awesome_icon_key]),
        'font_awesome_icon_size' => $_POST[$maxbutton_font_awesome_icon_size_key] != '' ? $wpdb->escape($_POST[$maxbutton_font_awesome_icon_size_key]) : $maxbutton_font_awesome_icon_size_default,
        'icon_url' => stripslashes($_POST[$maxbutton_icon_url_key]),
        ...
        'icon_color' => $_POST[$maxbutton_icon_color_key] != '' ? $wpdb->escape($_POST[$maxbutton_icon_color_key]) : $maxbutton_icon_color_default,
        'icon_color_hover' => $_POST[$maxbutton_icon_color_hover_key] != '' ? $wpdb->escape($_POST[$maxbutton_icon_color_hover_key]) : $maxbutton_icon_color_hover_default,
	...
	if ($button_id == '') {
		...
		$data_format = array('%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s');
...
<script type="text/javascript">
	...
	jQuery(document).ready(function() {		
		...
		jQuery("#view_icons_modal").leanModal({closeButton: ".modal_close"});
        ...
        showColorPickerForButtonIconColor();
		showColorPickerForButtonTextHoverColor();
        showColorPickerForButtonIconHoverColor();
		...
		function copy_normal_colors_to_hover() {
            ...
            var icon = jQuery("#<?php echo $maxbutton_icon_color_key ?>").val();
            ...
            jQuery("#<?php echo $maxbutton_icon_color_hover_key ?>").val(icon);
            jQuery("#<?php echo $maxbutton_icon_color_hover_key ?>_box span").css("background-color", icon);
		...
		function copy_hover_colors_to_normal() {
            ...
            var icon = jQuery("#<?php echo $maxbutton_icon_color_hover_key ?>").val();
            ...
            jQuery("#<?php echo $maxbutton_icon_color_key ?>").val(icon);
            jQuery("#<?php echo $maxbutton_icon_color_key ?>_box span").css("background-color", icon);
		...
		function swap_normal_hover_colors() {
            ...
            var icon_hover = jQuery("#<?php echo $maxbutton_icon_color_hover_key ?>").val();
            ...
            jQuery("#<?php echo $maxbutton_icon_color_key ?>").val(icon_hover);
            jQuery("#<?php echo $maxbutton_icon_color_key ?>_box span").css("background-color", icon_hover);
			...
			jQuery("#<?php echo $maxbutton_text_color_hover_key ?>").val(text);
			jQuery("#<?php echo $maxbutton_text_color_hover_key ?>_box span").css("background-color", text);
            jQuery("#<?php echo $maxbutton_text_color_hover_key ?>").val(icon);
            jQuery("#<?php echo $maxbutton_text_color_hover_key ?>_box span").css("background-color", icon);
			jQuery("#button-result-hover .text").css("color", text);
			jQuery("#button-result-hover .text2").css("color", text);
        ...
        // Begin Font Awesome Scripts
        if(jQuery('#maxbutton_use_font_awesome_icon').checked == 'checked') {
            jQuery('.non-fa').hide();
            jQuery('.fa-only').show();
        } else {
            jQuery('.non-fa').show();
        ...
        if(jQuery('#maxbutton_use_font_awesome_icon').attr('checked')) {
            jQuery('.non-fa').hide();
            jQuery('.fa-only').show();
            
            jQuery('#maxbutton_use_font_awesome_icon').toggleClass('checked');
            jQuery('.font-awesome').toggleClass('checked');
        }
        jQuery('#maxbutton_use_font_awesome_icon').change(function(){
            ...
            var icon_value = jQuery('#maxbutton_font_awesome_icon').val();
            var icon_found = jQuery("#maxbuttons .output .result a .button-output .icon i").length;
            ...
            if(checked == 'checked') {
                ...
                if(icon_value != ''){ 
                	if(icon_value != '') {
                		jQuery("#maxbuttons .output .result a .button-output .icon img").remove();
                		if(icon_found == 0) {
                			// need to adjust size and add colors
                			jQuery("#maxbuttons .output .result a .button-output .icon").append('<i class="fa '+icon_value+'"></i>');
                		}
                	}
                	jQuery("#maxbuttons .output .result a .button-output .icon i").addClass(icon_value);
                	jQuery("#maxbuttons .output .result a .button-output .icon i").show();
                }
            } else {
                jQuery('.non-fa').show();
                jQuery('.fa-only').hide();
                if(icon_url != '') {
                	jQuery("#maxbuttons .output .result a .button-output .icon i").remove();
                	jQuery("#maxbuttons .output .result a .button-output .icon").append('<img src="'+ icon_url +'" />');
                } else {
                	jQuery("#maxbuttons .output .result a .button-output .icon i").hide();
                }
            }
        ...
        // List of icons for Font Awesome
        jQuery('.icon-list li a').on('click', function(e) {
            e.preventDefault();
            var icon = jQuery(this).data('icon');
            console.log(icon);
            jQuery('.font-awesome-label i.fa').attr('class', 'fa').addClass(icon);
            jQuery('#maxbutton_font_awesome_icon').val(icon);
            jQuery('.modal_close').trigger('click');
        }); 

        // For Font Awesome
        jQuery(".font-awesome ul li a").click(function() {
            var icon_value = jQuery('#maxbutton_font_awesome_icon').val();
            console.log(icon_value);
            var icon_position = jQuery("#<?php echo $maxbutton_icon_position_key ?>").val() != "" ? jQuery("#<?php echo $maxbutton_icon_position_key ?>").val() : "";
            var padding_top     	= jQuery("#maxbutton_icon_padding_top").val();
            var padding_bottom  	= jQuery("#maxbutton_icon_padding_bottom").val();
            var padding_left    	= jQuery("#maxbutton_icon_padding_left").val();
            var padding_right   	= jQuery("#maxbutton_icon_padding_right").val();
            var padding         	= 'padding: ' + padding_top + 'px ' + padding_right + 'px ' + padding_bottom + 'px ' + padding_left + 'px;';
            var icon_size       	= jQuery("#maxbutton_font_awesome_icon_size").val();
            var icon_color 			= jQuery("#maxbutton_icon_color").val();
            var icon_color_hover 	= jQuery("#maxbutton_icon_color_hover").val();
            ...
            if (icon_value != "") {
                ...
                if (icon_position == "left") {
                    jQuery("#maxbuttons .output .result a .button-output").prepend("<div class='icon left' style='" + padding + " font-size:" + icon_size + "px; color: "+ icon_color +"'><i class='fa " + icon_value + "'></i></div>");
                    jQuery("#maxbuttons .output .result a .button-output .icon.left").css("float", icon_position);
                }

                if (icon_position == "right") {
                    jQuery("#maxbuttons .output .result a .button-output").prepend("<div class='icon right' style='" + padding + " font-size:" + icon_size + "px;'><i class='fa " + icon_value + "'></i></div>");
                    jQuery("#maxbuttons .output .result a .button-output .icon.right").css("float", icon_position);
                }
                
                if (icon_position == "top") {
                    jQuery("#maxbuttons .output .result a .button-output").prepend("<div class='icon top' style='" + padding + " font-size:" + icon_size + "px;'><i class='fa " + icon_value + "'></i></div>");
                    jQuery("#maxbuttons .output .result a .button-output .icon.top").css("text-align", "center");
                }
                
                if (icon_position == "bottom") {
                    jQuery("#maxbuttons .output .result a .button-output").append("<div class='icon bottom' style='" + padding + " font-size:" + icon_size + "px;'><i class='fa " + icon_value + "'></i></div>");
                    jQuery("#maxbuttons .output .result a .button-output .icon.bottom").css("text-align", "center");
                }
                jQuery("#maxbuttons .output .result a .button-output .icon ").css("color", icon_color);
                jQuery("#maxbuttons .output .result a.hover .button-output .icon ").css("color", icon_color_hover);
            }
        });
		...
		jQuery("#<?php echo $maxbutton_icon_position_key ?>").change(function() {
			...
			var font_awesome_checked = jQuery('#maxbutton_use_font_awesome_icon').checked;
            var icon_value = jQuery('#maxbutton_font_awesome_icon').val();
            var padding_top     = jQuery("#maxbutton_icon_padding_top").val();
            var padding_bottom  = jQuery("#maxbutton_icon_padding_bottom").val();
            var padding_left    = jQuery("#maxbutton_icon_padding_left").val();
			...
			if (icon_url != '' && font_awesome_checked === '') {
				jQuery("#maxbuttons .output .result a .button-output .icon").remove();
			...
			} else if(font_awesome_checked = 'checked') {
                jQuery("#maxbuttons .output .result a .button-output .icon").remove();
                
                if (icon_position == "left") {
                    jQuery("#maxbuttons .output .result a .button-output").prepend("<div class='icon left' style='" + padding + " font-size:" + icon_size + "px;'><i class='fa " + icon_value + "'></i></div>");
                    jQuery("#maxbuttons .output .result a .button-output .icon.left").css("float", icon_position);
                }
        ...
        jQuery("#<?php echo $maxbutton_font_awesome_icon_size_key ?>").keyup(function() {
            font_awesome_icon_size = jQuery(this).val() != "" ? jQuery(this).val() + "px" : "";
            jQuery("#maxbuttons .output .result a .button-output .icon").css("font-size", font_awesome_icon_size);
        });
        ...
        jQuery("#maxbuttons .output .result a .button-output .icon").css("font-size", "<?php echo $maxbutton_font_awesome_icon_size_value ?>px");
        jQuery("#maxbuttons .output .result a#button-result .button-output .icon i").css("color", "<?php echo $maxbutton_icon_color_value ?>px !important");
    ...
    function showColorPickerForButtonIconColor() {
        var icon_color = jQuery('#maxbutton_icon_color').val();
        jQuery('#<?php echo $maxbutton_icon_color_key ?>_box span').css('background-color', icon_color);
        jQuery('#<?php echo $maxbutton_icon_color_key ?>_box span').ColorPicker({
            'onBeforeShow': function () { jQuery(this).ColorPickerSetColor(jQuery('#maxbutton_icon_color').val()); },
            'onShow': function(colpkr) { jQuery(colpkr).fadeIn(500); return false; },
            'onHide': function(colpkr) { jQuery(colpkr).fadeOut(500); return false; },
            'onChange': function(hsb, hex, rgb) {
                jQuery('#<?php echo $maxbutton_icon_color_key ?>').attr('value', '#' + hex);
                jQuery('#<?php echo $maxbutton_icon_color_key ?>_box span').css('background-color', '#' + hex);
                jQuery("#button-result .icon").css("color", '#' + hex);
                
                // Need this so that the hover color doesn't change when the normal color changes
                var icon_color_hover = jQuery("#<?php echo $maxbutton_icon_color_hover_key ?>").val();
                jQuery("#button-result-hover .icon").css("color", icon_color_hover);
            }
        });
    }
    ...
    function showColorPickerForButtonIconHoverColor() {
        jQuery('#<?php echo $maxbutton_icon_color_hover_key ?>_box span').css('background-color', jQuery('#maxbutton_icon_color_hover').val());
        jQuery('#<?php echo $maxbutton_icon_color_hover_key ?>_box span').ColorPicker({
            'onBeforeShow': function () { jQuery(this).ColorPickerSetColor(jQuery('#maxbutton_icon_color_hover').val()); },
            'onShow': function(colpkr) { jQuery(colpkr).fadeIn(500); return false; },
            'onHide': function(colpkr) { jQuery(colpkr).fadeOut(500); return false; },
            'onChange': function(hsb, hex, rgb) {
                jQuery('#<?php echo $maxbutton_icon_color_hover_key ?>').attr('value', '#' + hex);
                jQuery('#<?php echo $maxbutton_icon_color_hover_key ?>_box span').css('background-color', '#' + hex);
                jQuery("#button-result-hover .icon").css("color", '#' + hex);
                
                // Need this so that the normal color doesn't change when the hover color changes
                var icon_color = jQuery("#<?php echo $maxbutton_icon_color_key ?>").val();
                jQuery("#button-result .icon").css("color", icon_color);
            }
        });
    }
	...
	<div class="wrap">
		...
		<form id="new-button-form" method="post">
			...
			<div class="option-container">
				...
				<div class="inside">
                    <div class="option-design">
                        <div class="label font-awesome-label"><?php _e('Use Font Awesome Icon', 'maxbuttons-pro') ?></div>
                        <div class="input">
                            <input type="checkbox" id="<?php echo $maxbutton_use_font_awesome_icon_key ?>" class="" name="<?php echo $maxbutton_use_font_awesome_icon_key ?>" <?php if ($maxbutton_use_font_awesome_icon_value == 'on') { echo 'checked="checked"'; } else { echo ''; } ?>>
                            <a class="button fa-only" id="view_icons_modal" name="view_icons" href="#view_icons" rel="leanModal">Select Icon</a>
                            <div id="view_icons">
                            	<div class="font-awesome">
                            		<h4>Choose from 479 icons</h4>
	                                <ul class="icon-list">
	                                    <?php foreach($mbpro_icon_array as $icon) {
	                                        echo '<li><a href="#" data-icon="'.$icon.'"><i class="fa '.$icon.'"></i></a></li>';
	                                    } ?>
	                                   
	                                </ul>
	                                <input id="<?php echo $maxbutton_font_awesome_icon_key; ?>" type="hidden" value="<?php echo $maxbutton_font_awesome_icon_value; ?>" name="<?php echo $maxbutton_font_awesome_icon_key; ?>">
	                                <a class="modal_close" style="display: none;">close</a>
	                            </div>
                            </div>
                        </div>
					...
					<div class="option-design use-image non-fa">
                    ...
                    <div class="option-design fa-only">
                        <div class="label"><?php _e('Icon Size', 'maxbuttons-pro') ?></div>
                        <div class="input"><input class="tiny-nopad" type="text" id="<?php echo $maxbutton_font_awesome_icon_size_key ?>" name="<?php echo $maxbutton_font_awesome_icon_size_key ?>" value="<?php echo mbpro_strip_px($maxbutton_font_awesome_icon_size_value) ?>" />px</div>
                        <div class="default"><?php _e('Default:', 'maxbuttons-pro') ?> <?php echo $maxbutton_font_awesome_icon_size_default ?></div>
                        <div class="clear"></div>
                    </div>
						...
						<div class="input">
							<table class="color-line" border="0" cellpadding="0" cellspacing="0">
								<tr>
                                    ...
                                    <th class="fa-only"><?php _e('Icon Color', 'maxbuttons-pro') ?></th>
								...
								<tr>
                                    ...
                                    <td class="fa-only">
                                        <span class="colorpicker-box" id="<?php echo $maxbutton_icon_color_key ?>_box">
                                            <span></span>
                                        </span>
                                        <input style="display: none;" type="text" id="<?php echo $maxbutton_icon_color_key ?>" name="<?php echo $maxbutton_icon_color_key ?>" value="<?php echo $maxbutton_icon_color_value ?>" />
                                        <div class="clear"></div>
                                    </td>
									<td>
								...
								<tr>
                                    ...
                                    <td class="fa-only">
                                        <span class="colorpicker-box" id="<?php echo $maxbutton_icon_color_hover_key ?>_box">
                                            <span></span>
                                        </span>
                                        <input style="display: none;" type="text" id="<?php echo $maxbutton_icon_color_hover_key ?>" name="<?php echo $maxbutton_icon_color_hover_key ?>" value="<?php echo $maxbutton_icon_color_hover_value ?>" />
                                        <div class="clear"></div>
                                    </td>
									<td>
				...
				<div class="result">
					<a href="<?php echo $maxbutton_url_value ?>" id="button-result">
						<div class="button-output">
                            <?php 
                                if ($maxbutton_icon_url_value != '' && $maxbutton_use_font_awesome_icon_value != 'on') {
                                    if ($maxbutton_icon_position_display != '' && $maxbutton_icon_position_display != 'bottom') { 
                                        echo '<div class="icon ' . $maxbutton_icon_position_display . '"><img src="' . $maxbutton_icon_url_value . '" /></div>';
                                    } 
                                } elseif( $maxbutton_use_font_awesome_icon_value == 'on' ) {
                                    if ($maxbutton_icon_position_display != '' && $maxbutton_icon_position_display != 'bottom') { 
                                        echo '<div class="icon ' . $maxbutton_icon_position_display . '" style="font-size: '.$maxbutton_font_awesome_icon_size_value . 'px; color: '. $maxbutton_icon_color_value .';"><i class="fa ' . $maxbutton_font_awesome_icon_value . '" ></i></div>';
                                    } 
                                }
                            ?>
                            ...
                            <?php 
                                if ($maxbutton_icon_url_value != '' && $maxbutton_use_font_awesome_icon_value != 'on') {
                                    if ($maxbutton_icon_position_display == 'bottom') { 
                                        echo '<div class="icon ' . $maxbutton_icon_position_display . '"><img src="' . $maxbutton_icon_url_value . '" /></div>';
                                    } 
                                } elseif( $maxbutton_use_font_awesome_icon_value == 'on' ) {
                                    if ($maxbutton_icon_position_display == 'bottom') { 
						...
						<div class="button-output">
							<?php 
                                if ($maxbutton_icon_url_value != '' && $maxbutton_use_font_awesome_icon_value != 'on') {
                                    ...
                                    if ($maxbutton_icon_position_display != '' && $maxbutton_icon_position_display != 'bottom') { 
                                        echo '<div class="icon ' . $maxbutton_icon_position_display . '" style="font-size: '.$maxbutton_font_awesome_icon_size_value . 'px; color: '. $maxbutton_icon_color_hover_value .';"><i class="fa ' . $maxbutton_font_awesome_icon_value . '"></i></div>';
                                    } 
                                }
                            ?>
