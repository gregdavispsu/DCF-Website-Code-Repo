...
<script type="text/javascript">
	...
	function copyButton(buttonId) {
		...
		jQuery("#<?php echo $maxbutton_use_font_awesome_icon_key ?>").val(jQuery("#maxbutton_use_font_awesome_icon_" + buttonId).val());
		jQuery("#<?php echo $maxbutton_font_awesome_icon_key ?>").val(jQuery("#maxbutton_font_awesome_icon_" + buttonId).val());
		jQuery("#<?php echo $maxbutton_font_awesome_icon_size_key ?>").val(jQuery("#maxbutton_font_awesome_icon_size_" + buttonId).val());
		...
		jQuery("#<?php echo $maxbutton_icon_color_key ?>").val(jQuery("#maxbutton_icon_color_" + buttonId).val());
		jQuery("#<?php echo $maxbutton_icon_color_hover_key ?>").val(jQuery("#maxbutton_icon_color_hover_" + buttonId).val());
	...
	<div class="wrap">
		...
		<div class="main">
			...
			<form id="pack-form" method="post" action="<?php echo admin_url() ?>admin.php?page=maxbuttons-controller&action=button">
				...
				<input type="hidden" id="<?php echo $maxbutton_use_font_awesome_icon_key ?>" name="<?php echo $maxbutton_use_font_awesome_icon_key ?>" />
				<input type="hidden" id="<?php echo $maxbutton_font_awesome_icon_key ?>" name="<?php echo $maxbutton_font_awesome_icon_key ?>" />
				<input type="hidden" id="<?php echo $maxbutton_font_awesome_icon_size_key ?>" name="<?php echo $maxbutton_font_awesome_icon_size_key ?>" />
				...
				<input type="hidden" id="<?php echo $maxbutton_icon_color_key ?>" name="<?php echo $maxbutton_icon_color_key ?>" />
				<input type="hidden" id="<?php echo $maxbutton_icon_color_hover_key ?>" name="<?php echo $maxbutton_icon_color_hover_key ?>" />
