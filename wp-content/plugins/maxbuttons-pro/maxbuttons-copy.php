...
if (isset($_GET['id']) && $_GET['id'] != '') {
	...
	$data = array(
		...
		'use_font_awesome_icon' => $button->use_font_awesome_icon,
		'font_awesome_icon' => $button->font_awesome_icon,
		'font_awesome_icon_size' => $button->font_awesome_icon_size,
		...
		'icon_color_hover' => $button->icon_color_hover,
