    ...
    $(function(){
        ...
        function soliloquyFcInit() {
            ...
            if ( soliloquy_fc_post_type_val ) {
                if ( soliloquy_fc_post_type_val.length >= 2 ) {
                    ...
                    if ( ! chosen_term ) {
                        chosen_term = true;
                        soliloquyFcRefreshTermsCondMulti(soliloquy_fc_post_type_val);
                    } else {
        ...
        function soliloquyFcConditionals() {
            ...
            if ( 'post_content' == $('#soliloquy-config-fc-content-type').val() ) {
                $('#soliloquy-config-fc-content-length-box, #soliloquy-config-fc-content-ellipses-box').show();
            } else {
                $('#soliloquy-config-fc-content-length-box, #soliloquy-config-fc-content-ellipses-box').hide();
            }
            $(document).on('change', '#soliloquy-config-fc-content-type', function(){
                if ( 'post_content' == $(this).val() )
                    $('#soliloquy-config-fc-content-length-box, #soliloquy-config-fc-content-ellipses-box').fadeIn();
                else
                    $('#soliloquy-config-fc-content-length-box, #soliloquy-config-fc-content-ellipses-box').fadeOut();
            });
