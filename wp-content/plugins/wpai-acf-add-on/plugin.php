...
if ( class_exists('PMAI_Plugin') and PMAI_EDITION == "free"){
	...
	function pmai_notice(){
		...
		?>
		<div class="error"><p>
			<?php printf(__('Please de-activate and remove the free version of the WooCommere add-on before activating the paid version.', 'PMAI_Plugin'));
			?>
		</p></div>
		<?php				
	...
	final class PMAI_Plugin {
		...
		static public function getEddName(){
			return 'Advanced Custom Fields Add-On';
		}
