...
function it_exchange_register_customer_pricing_addon() {
	$options = array(
		'name'              => __( 'Customer Pricing', 'it-l10n-exchange-addon-customer-pricing' ),
		'description'       => __( 'Let customers choose their price from a list of price options you create or let them enter their own price.', 'it-l10n-exchange-addon-customer-pricing' ),
		'author'            => 'iThemes',
		...
		'labels'      => array(
			'singular_name' => __( 'Customer Pricing', 'it-l10n-exchange-addon-customer-pricing' ),
		),
...
function it_exchange_customer_pricing_set_textdomain() {
	load_plugin_textdomain( 'it-l10n-exchange-addon-customer-pricing', false, dirname( plugin_basename( __FILE__  ) ) . '/lang/' );
}
